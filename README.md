...
Schedule 6 is a timetable, and task manager application. Users are able to import their calendars, add, edit, and delete events on the timetable. The To-do list enables users to create, edit, and delete tasks.
